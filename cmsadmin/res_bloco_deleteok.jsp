...
<span class='text'><b><%=(tex!=null?tex.getBlk_tag() + " -> " + tex.getBlk_name():"Not found!")%></b></span>
...
<%}%>
<input name='btBack' type='button' class='pageButton' value='Return to list' onClick='location.href="res_bloco_list.jsp?key=<%=key%>&token=<%=token%>";'>
</td></tr></table>
</body>
</html>
