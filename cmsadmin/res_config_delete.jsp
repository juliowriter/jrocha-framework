...
<span class='text'><b><%=tex.getCfg_tag()%></b></span>
	...
	<input name='btSubmit' type='button' class='pageButton' value='Proceed and delete' onClick='location.href="res_config_deleteok.jsp?id=<%=id%>&key=<%=key%>&token=<%=token%>";'>&nbsp;&nbsp;&nbsp;
