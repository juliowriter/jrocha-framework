...
<span class='text'><b><%=(tex!=null?tex.getFrm_nome():"Item not found!")%></b></span>
...
<%}%>
<input name='btBack' type='button' class='pageButton' value='Return to list' onClick='location.href="res_form_list.jsp?key=<%=key%>&token=<%=token%>";'>
</td></tr></table>
</body>
</html>
