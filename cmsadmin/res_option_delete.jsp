...
<span class='text'><b><%=tex.getOpt_title() + " -> " + tex.getOpt_link()%></b></span>
	...
	<input name='btSubmit' type='button' class='pageButton' value='Proceed and delete' onClick='location.href="res_option_deleteok.jsp?id=<%=id%>&key=<%=key%>&token=<%=token%>";'>&nbsp;&nbsp;&nbsp;
