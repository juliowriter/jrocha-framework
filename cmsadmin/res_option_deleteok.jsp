...
<span class='pageLabel'>Menu Option:</span>
<span class='text'><b><%=(tex!=null?tex.getOpt_title() + " -> " + tex.getOpt_link():"Item not found!")%></b></span>
...
<%}%>
<input name='btBack' type='button' class='pageButton' value='Return to list' onClick='location.href="res_option_list.jsp?key=<%=key%>&token=<%=token%>";'>
</td></tr></table>
</body>
</html>
