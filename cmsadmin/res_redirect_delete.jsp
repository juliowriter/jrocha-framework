...
<span class='text'><b><%=tex.getRed_tipo()%></b></span>
	...
	<input name='btSubmit' type='button' class='pageButton' value='Proceed and delete' onClick='location.href="res_redirect_deleteok.jsp?frmID=<%=frmID%>&id=<%=id%>&key=<%=key%>&token=<%=token%>";'>&nbsp;&nbsp;&nbsp;
