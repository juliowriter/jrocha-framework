...
Content obj = new Content().getContent(id);
%>
<span class="listTitle">Versions of this page <%=obj.getCts_tag()%></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="res_texto_list.jsp?token=<%=token%>&key=<%=key%>"><img src='../img/ico_up.gif'></a><br>
...
if(versoes!=null && versoes.length > 0)
{
	for(int xx=0; xx < versoes.length;xx++)
	{
	   ...
	   String linkEdit = "<a href='res_texto_restoreto.jsp?cthID=" + linha[0] + "&date=" + linha[1] + "&" + parameterString + "'>";
	   String linkEditX = "</a>";
	   %>
	    <tr class=listBody>
	    <td>
