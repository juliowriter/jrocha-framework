...
<span class='text'><b><%=tex.getCts_tag() + " -> " + data%></b></span>
	...
	<input name='btSubmit' type='button' class='pageButton' value='Proceed' onClick='location.href="res_texto_restore_action.jsp?id=<%=id%>&cthID=<%=cthID%>&key=<%=key%>&token=<%=token%>";'>&nbsp;&nbsp;&nbsp;
